        ...
        <div className='h-screen bg-black'>
            <div className='grid grid-cols-1'>
                ...
                <div className='col-span-1 text-center'>
                    ...
                    <div>
                        <br />
                        {change !== "Sirojiddin" && change !== "Sevinch" && change !== "Shoxjaxon"  && change !== "Saida" && change !== "Sabina" && change !== "Azamat" && change !== "Asadbek" && change !== "Sardor" && change !== "Nasiba" && change !== "Marhamat" && change !== "Marxamat" && change !== "Muxiddin" && change !== "Komoliddin" && change !== "Nargiza" && change !== "Xakimjon" && change !== "Otabek" && change !== "Salohiddin" && change !== "Dilnoza" && change !== "Afruza" && change !== "Axmaral" && change !== "Ahmaral" ? (
